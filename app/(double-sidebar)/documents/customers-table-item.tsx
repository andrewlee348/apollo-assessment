...
import { Document } from "./customers-table";
    ...
    <tr>
      ...
      {/* <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
        <div className="flex items-center relative">
          <button>
            <svg className={`shrink-0 fill-current ${customer.fav ? 'text-yellow-500' : 'text-gray-300 dark:text-gray-600'}`} width="16" height="16" viewBox="0 0 16 16">
      ...
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div
          ...
          onClick={() => handleDocumentClick(customer)}
        >
