                ...
                <SidebarLink href="/documents">
                  <div className="flex items-center">
                    <svg
                      ...
                      viewBox="0 0 128 128"
                    >
                      <path d="M85.1 94.5H41c-1.7 0-3-1.3-3-3s1.3-3 3-3h44.1c1.7 0 3 1.3 3 3S86.8 94.5 85.1 94.5zM85.1 76.2H41c-1.7 0-3-1.3-3-3s1.3-3 3-3h44.1c1.7 0 3 1.3 3 3S86.8 76.2 85.1 76.2zM85.1 57.8H41c-1.7 0-3-1.3-3-3s1.3-3 3-3h44.1c1.7 0 3 1.3 3 3S86.8 57.8 85.1 57.8z" />
                      <g>
                        <path d="M110,29.8L87.1,6.9C86.5,6.4,85.6,6,84.7,6c0,0,0,0,0,0H24.7c-4.2,0-7.6,3.4-7.6,7.6v100.8c0,4.2,3.4,7.6,7.6,7.6h78.6c4.2,0,7.6-3.4,7.6-7.6V31.9C110.9,31.1,110.5,30.3,110,29.8z M88,16.2l12.7,12.7H89.6c-0.9,0-1.6-0.7-1.6-1.6V16.2z M104.8,114.4c0,0.9-0.7,1.6-1.6,1.6H24.7c-0.9,0-1.6-0.7-1.6-1.6V13.6c0-0.9,0.7-1.6,1.6-1.6h57.2v15.3c0,4.2,3.4,7.6,7.6,7.6h15.3V114.4z"></path>
                      </g>
                    </svg>
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                      Documents
